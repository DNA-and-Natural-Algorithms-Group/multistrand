...
python case1.py plots 1600			> case1_plots.txt;
python case1.py slowDownStudy 1600		> case1_slowdown.txt;

## These are the trajectory studies of P0, P3, P4.
## 8 processes, <24 hr

python case3.py 8 1600 P4			> case3_P4.txt	
python case3.py 8 1600 P3;			> case3_P3.txt
python case3.py 8 1600 P0;			> case3_p0.txt
...
## Finally, do the rickettsia.

python barplots.py 8 16 rickettsia > barplots_output_rickettsia.txt;
