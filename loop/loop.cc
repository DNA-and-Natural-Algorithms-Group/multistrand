      ...
      for( loop = 0; loop < sizes[flipflop] ; loop++ )
        {
          if( loop < index[flipflop])
          ...
          else
            {
              ...
              temp = tempLoop[1-flipflop]->adjacentLoops[loop - index[flipflop] + index[1-flipflop] + 1]->replaceAdjacent( tempLoop[1-flipflop], newLoop );
              assert( temp > 0 );
...
double Loop::generateDeleteMoveRate( Loop *start, Loop *end )
{
  ...
  if( start->identity == 'S' && end->identity == 'S' )
    {
      ...
      new_energy = energyModel_Primary->InteriorEnergy( start_->seqs[s_index], end_->seqs[e_index], 1 , 1 );
  ...
  if( (start->identity == 'S' && end->identity == 'I') ||
      (start->identity == 'I' && end->identity == 'S') )
    {
      ...
      new_energy = energyModel_Primary->InteriorEnergy(start_->seqs[s_index], end_->int_seq[e_index], end_->sizes[1-e_index]+1, end_->sizes[e_index]+1);
  ...
  if( (start->identity == 'S' && end->identity == 'B') ||
      (start->identity == 'B' && end->identity == 'S') )
    {
      ...
      new_energy = energyModel_Primary->InteriorEnergy( start_->seqs[s_index], end_->bulge_seq[e_index], end_->bulgesize[1-e_index]+1, end_->bulgesize[e_index]+1 );
  ...
  if( (start->identity == 'S' && end->identity == 'H') ||
      (start->identity == 'H' && end->identity == 'S') )
    {
      ...
      new_energy = energyModel_Primary->HairpinEnergy( start_->seqs[s_index], end_->hairpinsize+2 );
      old_energy = start->getEnergy() + end->getEnergy();
      temprate = energyModel_Primary->returnRate( old_energy, new_energy, 0);
      return temprate/2.0;
    }
  ...
  if( (start->identity == 'S' && end->identity == 'M') ||
      (start->identity == 'M' && end->identity == 'S') )
    {
      ...
      new_energy = energyModel_Primary->MultiloopEnergy( end_->numAdjacent, sidelens, seqs );
  ...
  if( (start->identity == 'S' && end->identity == 'O') ||
      (start->identity == 'O' && end->identity == 'S') )
    {
      ...
      new_energy = energyModel_Primary->OpenloopEnergy( end_->numAdjacent, sidelens, seqs );
  ...
  if(start->identity == 'I' && end->identity == 'I')
    {
      ...
      new_energy = energyModel_Primary->InteriorEnergy( start_->int_seq[s_index], end_->int_seq[e_index],  end_->sizes[1-e_index]+start_->sizes[s_index]+1, end_->sizes[e_index]+start_->sizes[1-s_index]+1 );
  ...
  if( (start->identity == 'I' && end->identity == 'B') ||
      (start->identity == 'B' && end->identity == 'I') )
    {
      ...
      new_energy = energyModel_Primary->InteriorEnergy( start_->int_seq[s_index], end_->bulge_seq[e_index], end_->bulgesize[1-e_index]+1+start_->sizes[s_index], end_->bulgesize[e_index]+1+start_->sizes[1-s_index]);
  ...
  if( (start->identity == 'I' && end->identity == 'H') ||
      (start->identity == 'H' && end->identity == 'I') )
    {
      ...
      new_energy = energyModel_Primary->HairpinEnergy( start_->int_seq[s_index], end_->hairpinsize+2+start_->sizes[0]+start_->sizes[1] );
      old_energy = start->getEnergy() + end->getEnergy();
      temprate = energyModel_Primary->returnRate( old_energy, new_energy, 0);
      return temprate/2.0;
    }
  ...
  if(start->identity == 'B' && end->identity == 'B')
    {
      ...
      new_energy = energyModel_Primary->InteriorEnergy( start_->bulge_seq[s_index], end_->bulge_seq[e_index], end_->bulgesize[1-e_index]+start_->bulgesize[s_index]+1, end_->bulgesize[e_index]+start_->bulgesize[1-s_index]+1 );
  ...
  if( (start->identity == 'B' && end->identity == 'H') ||
      (start->identity == 'H' && end->identity == 'B') )
    {
      ...
      new_energy = energyModel_Primary->HairpinEnergy( start_->bulge_seq[s_index], end_->hairpinsize+2+start_->bulgesize[0]+start_->bulgesize[1] );
      old_energy = start->getEnergy() + end->getEnergy();
      temprate = energyModel_Primary->returnRate( old_energy, new_energy, 0);
      return temprate/2.0;
    }
      ...
      (start->identity == 'M' && end->identity == 'H') )
    {
      ...
      if(end_->numAdjacent == 3 )
          ...
          if( sizes[1] > 0 ) // interior loop case
            {
              ...
              new_energy = energyModel_Primary->InteriorEnergy( end_->seqs[positions[1]], end_->seqs[positions[0]], sizes[0], sizes[1] );
          ...
          else  // bulge loop case
            {
              ...
              new_energy = energyModel_Primary->BulgeEnergy( end_->seqs[positions[1]][0], end_->seqs[positions[0]][sizes[1]+1], end_->seqs[positions[1]][sizes[0]+1], end_->seqs[positions[0]][0], sizes[0]);
              old_energy = start->getEnergy() + end->getEnergy();
              temprate = energyModel_Primary->returnRate( old_energy, new_energy, 0);
              return temprate/2.0;
      ...
      else if (end_->numAdjacent > 3)// multiloop case
        {
          ...
          new_energy = energyModel_Primary->MultiloopEnergy( end_->numAdjacent-1, sidelens, seqs );
  ...
  if( (start->identity == 'H' && end->identity == 'O') ||
      (start->identity == 'O' && end->identity == 'H') )
    {
      ...
      */
      ...
      new_energy = energyModel_Primary->OpenloopEnergy( end_->numAdjacent-1, sidelens, seqs );
  ...
  if( start->identity == 'M' && end->identity == 'M')
    {
      ...
      new_energy = energyModel_Primary->MultiloopEnergy( start_->numAdjacent + end_->numAdjacent - 2, sidelens, seqs );
  ...
  if( (start->identity == 'M' && end->identity == 'O') ||
      (start->identity == 'O' && end->identity == 'M') )
    {
      ...
      new_energy = energyModel_Primary->OpenloopEnergy( start_->numAdjacent + end_->numAdjacent - 2, sidelens, seqs );
  ...
  if( start->identity == 'S' && end->identity == 'S' )
    {
      ...
      if( ((StackLoop *) start)->seqs[0] > ((StackLoop *)end)->seqs[0])
        {
          start_ = (StackLoop *)end; end_ = (StackLoop *)start;
        }
      else
        {
          start_ = (StackLoop *)start; end_ = (StackLoop *)end;
        }
  ...
  if( (start->identity == 'S' && end->identity == 'I') ||
      (start->identity == 'I' && end->identity == 'S') )
    {
      ...
      if( start_->seqs[s_index] < end_->int_seq[e_index] )
        {
          newLoop = new InteriorLoop( start_->pairtype[s_index], end_->pairtype[e_index], end_->sizes[1-e_index]+1, end_->sizes[e_index]+1, start_->seqs[s_index], end_->int_seq[e_index]);
        ...
        {
          newLoop = new InteriorLoop( end_->pairtype[e_index], start_->pairtype[s_index], end_->sizes[e_index]+1, end_->sizes[1-e_index]+1, end_->int_seq[e_index], start_->seqs[s_index]);
  ...
  if( (start->identity == 'S' && end->identity == 'B') ||
      (start->identity == 'B' && end->identity == 'S') )
    {
      ...
      if( start_->seqs[s_index] < end_->bulge_seq[e_index] )
        {
          newLoop = new InteriorLoop( start_->pairtype[s_index], end_->pairtype[e_index], end_->bulgesize[1-e_index]+1, end_->bulgesize[e_index]+1, start_->seqs[s_index], end_->bulge_seq[e_index]);
        ...
        {
          newLoop = new InteriorLoop( end_->pairtype[e_index], start_->pairtype[s_index], end_->bulgesize[e_index]+1, end_->bulgesize[1-e_index]+1, end_->bulge_seq[e_index], start_->seqs[s_index]);
  ...
  if( start->identity == 'I' && end->identity == 'I') 
    {
      ...
      if( start_->int_seq[s_index] < end_->int_seq[e_index] )
        {
          newLoop = new InteriorLoop( start_->pairtype[s_index], end_->pairtype[e_index], end_->sizes[1-e_index]+start_->sizes[s_index]+1, end_->sizes[e_index]+start_->sizes[1-s_index]+1, start_->int_seq[s_index], end_->int_seq[e_index]);
        ...
        {
          newLoop = new InteriorLoop( end_->pairtype[e_index], start_->pairtype[s_index], end_->sizes[e_index]+start_->sizes[1-s_index]+1, end_->sizes[1-e_index]+start_->sizes[s_index]+1, end_->int_seq[e_index], start_->int_seq[s_index]);
  ...
  if( (start->identity == 'I' && end->identity == 'B') ||
      (start->identity == 'B' && end->identity == 'I') )
    {
      ...
      if( start_->int_seq[s_index] < end_->bulge_seq[e_index] )
        {
          newLoop = new InteriorLoop( start_->pairtype[s_index], end_->pairtype[e_index], end_->bulgesize[1-e_index]+1+start_->sizes[s_index], end_->bulgesize[e_index]+1+start_->sizes[1-s_index], start_->int_seq[s_index], end_->bulge_seq[e_index]);
        ...
        {
          newLoop = new InteriorLoop( end_->pairtype[e_index], start_->pairtype[s_index], end_->bulgesize[e_index]+1+start_->sizes[1-s_index], end_->bulgesize[1-e_index]+1+start_->sizes[s_index], end_->bulge_seq[e_index], start_->int_seq[s_index]);
  ...
  if( start->identity == 'B' && end->identity == 'B') 
    {
      ...
      if( start_->bulge_seq[s_index] < end_->bulge_seq[e_index] )
        {
          newLoop = new InteriorLoop( start_->pairtype[s_index], end_->pairtype[e_index], end_->bulgesize[1-e_index]+start_->bulgesize[s_index]+1, end_->bulgesize[e_index]+start_->bulgesize[1-s_index]+1, start_->bulge_seq[s_index], end_->bulge_seq[e_index]);
        ...
        {
          newLoop = new InteriorLoop( end_->pairtype[e_index], start_->pairtype[s_index], end_->bulgesize[e_index]+start_->bulgesize[1-s_index]+1, end_->bulgesize[1-e_index]+start_->bulgesize[s_index]+1, end_->bulge_seq[e_index], start_->bulge_seq[s_index]);
          ...
          if( sizes[1] > 0 ) // interior loop case
            {
              ...
              /*	      
                          if( end_->seqs[positions[0]] > end_->seqs[positions[1]] )
                          {*/
              newLoop = new InteriorLoop( end_->pairtype[positions[1]], end_->pairtype[positions[0]], sizes[0], sizes[1], end_->seqs[positions[1]], end_->seqs[positions[0]]);
            ...
            {
              newLoop = new BulgeLoop(end_->pairtype[positions[0]], end_->pairtype[positions[1]], sizes[1], sizes[0], end_->seqs[positions[0]], end_->seqs[positions[1]]);
...
void StackLoop::calculateEnergy( void )
{
  ...
  energy = Loop::energyModel_Primary->StackEnergy( seqs[0][0], seqs[1][1], seqs[0][1], seqs[1][0]);
  return;
}
...
void StackLoop::generateDeleteMoves( void )
{
  ...
  if(temprate >= 0.0)
    moves->addMove( new Move( MOVE_DELETE | MOVE_1, temprate , this, adjacentLoops[0], 0 ));
  temprate = Loop::generateDeleteMoveRate( this, adjacentLoops[1] );
  if(temprate >= 0.0)
    moves->addMove( new Move( MOVE_DELETE | MOVE_1, temprate , this, adjacentLoops[1], 1 ));  
...
HairpinLoop::HairpinLoop( int type, int size, char *hairpin_sequence, Loop *previous )
{
  ...
  if( previous != NULL ) curAdjacent = 1;
  ...
  else
    {
      ...
      for( loop = 1; loop <= hairpinsize-4 ; loop++ )
        for( loop2 = loop+4; loop2 <= hairpinsize; loop2++ )
          {
            if( pt = pairtypes[hairpin_seq[loop]][hairpin_seq[loop2]] != 0 )
              { // the two could pair. Work out energies of the resulting pair of loops.
                ...
                if( loop == 1 && loop2 == hairpinsize )
                  {
                    energies[0] = energyModel_Primary->StackEnergy( hairpin_seq[0], hairpin_seq[hairpinsize+1], hairpin_seq[loop], hairpin_seq[loop2] );
                    energies[1] = energyModel_Primary->HairpinEnergy( &hairpin_seq[1], hairpinsize-2 );
                    temprate = energyModel_Primary->returnRate( getEnergy(), (energies[0] + energies[1]), 0);
                ...
                // bulge + hairpin
                else if( loop == 1 || loop2 == hairpinsize )
                  {
                    ...
                    energies[0] = energyModel_Primary->BulgeEnergy( hairpin_seq[0], hairpin_seq[hairpinsize+1], hairpin_seq[loop], hairpin_seq[loop2], (loop - 1)+(hairpinsize - loop2));
		  
                    // loop2 - loop - 1 is the new hairpin size.

                    energies[1] = energyModel_Primary->HairpinEnergy( &hairpin_seq[loop], loop2 - loop - 1 );
                ...
                else // interior loop + hairpin case.
                  {
                    ...
                    energies[0] = energyModel_Primary->InteriorEnergy( hairpin_seq, &hairpin_seq[loop2], loop-1, hairpinsize - loop2);
...
void BulgeLoop::calculateEnergy( void )
{
  ...
  energy = energyModel_Primary->BulgeEnergy( bulge_seq[0][0], bulge_seq[1][bulgesize[1]+1], bulge_seq[0][bulgesize[0]+1], bulge_seq[1][0], bulgesize[0]+bulgesize[1]);
  return;
}
  ...
  else
    {
      ...
      for( loop = 1; loop <= bsize-4 ; loop++ )
        for( loop2 = loop+4; loop2 <= bsize; loop2++ )
          {
            if( pt = pairtypes[bulge_seq[bside][loop]][bulge_seq[bside][loop2]] != 0 )
              { // the two could pair. Work out energies of the resulting pair of loops.
                ...
                energies[0] = energyModel_Primary->MultiloopEnergy( 3 , sidelen, sequences );


                // loop2 - loop + 1 is the new hairpin size.
                energies[1] = energyModel_Primary->HairpinEnergy( &bulge_seq[bside][loop],  loop2 - loop - 1 );
...
void BulgeLoop::printMove( Loop *comefrom, char *structure_p , char *seq_p)
{
  ...
  /*
    structure_p[ bulge_seq[0] - seq_p ] = '*';
    structure_p[ bulge_seq[1] - seq_p +1+bulgesize[1]] = '*';
    structure_p[ bulge_seq[0] - seq_p +1+bulgesize[0]] = '*';
    structure_p[ bulge_seq[1] - seq_p ] = '*';
  *//**/
...
void InteriorLoop::calculateEnergy( void )
{
  ...
  energy = energyModel_Primary->InteriorEnergy( int_seq[0], int_seq[1], sizes[0], sizes[1] );
  return;
}
...
void InteriorLoop::generateMoves( void )
{
  ...
  for( loop = 1; loop <= sizes[0] - 4; loop++ )
    for( loop2 = loop+4; loop2 <= sizes[0]; loop2++ )
      { // each possibility will always result in a new hairpin + multiloop.
        if( pt = pairtypes[int_seq[0][loop]][int_seq[0][loop2]] != 0) 
          {
            energies[0] = energyModel_Primary->HairpinEnergy( &int_seq[0][loop], loop2-loop-1 );
            ...
            energies[1] = energyModel_Primary->MultiloopEnergy( 3, sidelen, sequences );
  ...
  for( loop = 1; loop <= sizes[1] - 4; loop++ )
    for( loop2 = loop+4; loop2 <= sizes[1]; loop2++ )
      { // each possibility will always result in a new hairpin + multiloop.
        if( pt = pairtypes[int_seq[1][loop]][int_seq[1][loop2]] != 0) 
          {
            energies[0] = energyModel_Primary->HairpinEnergy( &int_seq[1][loop], loop2-loop-1 );
    ...
    for( loop2 = 1; loop2 <= sizes[1]; loop2++ )
      {
        ...
        if( pt != 0) 
          { 
            ...
            // adjacent to first pair side:
            if( loop == 1 && loop2 == sizes[1] ) // stack
              energies[0] = energyModel_Primary->StackEnergy( int_seq[0][0], int_seq[1][sizes[1]+1], int_seq[0][loop], int_seq[1][loop2] );
            else if( loop == 1 || loop2 == sizes[1]) // bulge
              energies[0] = energyModel_Primary->BulgeEnergy( int_seq[0][0], int_seq[1][sizes[1]+1], int_seq[0][loop], int_seq[1][loop2], (loop - 1) + (sizes[1] - loop2));
            else  // interior
              {
                //		char mismatches[4] = { int_seq[0][1], int_seq[1][sizes[1]], int_seq[0][loop-1], int_seq[1][loop2+1]};
                energies[0] = energyModel_Primary->InteriorEnergy( int_seq[0], &int_seq[1][loop2], loop-1, sizes[1]-loop2  );
            ...
            // other side
            if( loop == sizes[0] && loop2 == 1 ) // stack
              energies[1] = energyModel_Primary->StackEnergy(int_seq[0][loop], int_seq[1][loop2], int_seq[0][sizes[0]+1], int_seq[1][0]);
            else if( loop == sizes[0] || loop2 == 1 ) // bulge
              energies[1] = energyModel_Primary->BulgeEnergy( int_seq[0][loop], int_seq[1][loop2], int_seq[0][sizes[0]+1], int_seq[1][0], (loop2 - 1) + (sizes[0] - loop));
            else // interior
              {
                ...
                energies[1] = energyModel_Primary->InteriorEnergy( &int_seq[0][loop], int_seq[1], sizes[0]-loop, loop2-1 );
...
void InteriorLoop::moveDisplay( Loop *comefrom, char * structure_p , char *seq_p)
{
  int loop;
  Move *temp;
  for(loop = 0 ; loop < curAdjacent ; loop++ )
...
void MultiLoop::generateMoves( void )
{
  ...
  for( loop3 = 0; loop3 < numAdjacent; loop3++ ) 
    for( loop = 1; loop <= sidelen[loop3] - 4; loop++ )
      for( loop2 = loop+4; loop2 <= sidelen[loop3]; loop2++ )
        { // each possibility is a hairpin and multiloop, see above.
          if( pt = pairtypes[seqs[loop3][loop]][seqs[loop3][loop2]] != 0) 
            {
              energies[0] = energyModel_Primary->HairpinEnergy( &seqs[loop3][loop], loop2-loop-1 );
              ...
              energies[1] = energyModel_Primary->MultiloopEnergy( numAdjacent+1 , sidelengths, sequences );
  ...
  for( loop3 = 0; loop3 <= numAdjacent-1; loop3++ ) // CHECK: is numAdjacent really correct? it could be numAdjacent+1
    for( loop = 1; loop <= sidelen[loop3]; loop++ )
      for( loop2 = 1; loop2 <= sidelen[(loop3+1)%numAdjacent]; loop2++ )
        { // each possibility is a hairpin and open loop, see above.
          loop4 = (loop3+1)%numAdjacent;
          if( pt = pairtypes[seqs[loop3][loop]][seqs[loop4][loop2]] != 0) 
            {
              ...
              if( loop == sidelen[loop3] && loop2 == 1 ) 
                {
                  energies[0] = energyModel_Primary->StackEnergy(seqs[loop3][loop], seqs[loop4][loop2], seqs[loop3][sidelen[loop3]+1], seqs[loop4][0]);
                }
              // #2b: bulge
              else if( loop == sidelen[loop3] || loop2 == 1 )
                { 
                  if( loop2 == 1 )
                    energies[0] = energyModel_Primary->BulgeEnergy( seqs[loop3][loop], seqs[loop4][loop2], seqs[loop3][sidelen[loop3]+1], seqs[loop4][0], sidelen[loop3] - loop);
                  else
                    energies[0] = energyModel_Primary->BulgeEnergy( seqs[loop3][loop], seqs[loop4][loop2], seqs[loop3][sidelen[loop3]+1], seqs[loop4][0], loop2 - 1 );
                }
              // #2c: interior
              else
                {
                  //		  char mismatches[4] = { seqs[loop3][loop+1], seqs[loop4][loop2-1], seqs[loop3][sidelen[loop3]], seqs[loop4][1]};
                  energies[0] = energyModel_Primary->InteriorEnergy( &seqs[loop3][loop], seqs[loop4], sidelen[loop3]-loop, loop2-1 );
              ...
              energies[1] = energyModel_Primary->MultiloopEnergy( numAdjacent , sidelengths, sequences );
    ...
    for( loop4 = loop3+2; (loop4 < numAdjacent) && (loop3 != 0 || loop4 < numAdjacent - 1 ) ; loop4++ )
      for( loop = 1; loop <= sidelen[loop3] ; loop++ ) 
        for( loop2 = 1; loop2 <= sidelen[loop4]; loop2++ )
          {
            if( pt = pairtypes[seqs[loop3][loop]][seqs[loop4][loop2]] != 0 )
              {// result is a multiloop and multi loop. 
                // Multiloop
                ...
                energies[0] = energyModel_Primary->MultiloopEnergy( loop4 - loop3 + 1 , sidelengths, sequences );
                ...
                energies[1] = energyModel_Primary->MultiloopEnergy( numAdjacent - (loop4 - loop3 - 1), sidelengths, sequences );
                temprate = energyModel_Primary->returnRate( getEnergy(), (energies[0] + energies[1]), 0);
                loops[0] = loop;
                loops[1] = loop2;
                loops[2] = loop3;
  ...
  for( int loop = 0; loop < numAdjacent; loop++ )
    {
      ...
      if( temprate >= 0.0 )
        moves->addMove( new Move( MOVE_DELETE | MOVE_1, temprate, this, adjacentLoops[loop], loop ));
    }
...
char *MultiLoop::verifyLoop(char *incoming_sequence, int incoming_pairtype, Loop *from )
{
  ...
  for( loop = 0, adjacent = numAdjacent-1; loop < numAdjacent; loop++, adjacent++ )
    {
      if( adjacent == numAdjacent ) adjacent = 0;
...
void OpenLoop::generateMoves( void )
{
          ...
          if( pt = pairtypes[seqs[loop3][loop]][seqs[loop3][loop2]] != 0) 
            {
              ...
              energies[1] = energyModel_Primary->OpenloopEnergy( numAdjacent+1 , sidelengths, sequences );
  ...
  for( loop3 = 0; loop3 <= numAdjacent-1; loop3++ ) // CHECK: is numAdjacent really correct? it could be numAdjacent+1
    for( loop = 1; loop <= sidelen[loop3]; loop++ )
      for( loop2 = 1; loop2 <= sidelen[loop3+1]; loop2++ )
        { // each possibility is a hairpin and open loop, see above.
          if( pt = pairtypes[seqs[loop3][loop]][seqs[loop3+1][loop2]] != 0) 
            {
              ...
              if( loop == sidelen[loop3] && loop2 == 1 ) 
                {
                  energies[0] = energyModel_Primary->StackEnergy(seqs[loop3][loop], seqs[loop3+1][loop2], seqs[loop3][sidelen[loop3]+1], seqs[loop3+1][0]);
                }
              // #2b: bulge
              else if( loop == sidelen[loop3] || loop2 == 1 )
                { 
                  if( loop2 == 1 )
                    energies[0] = energyModel_Primary->BulgeEnergy( seqs[loop3][loop], seqs[loop3+1][loop2], seqs[loop3][sidelen[loop3]+1], seqs[loop3+1][0], sidelen[loop3] - loop);
                  else
                    energies[0] = energyModel_Primary->BulgeEnergy( seqs[loop3][loop], seqs[loop3+1][loop2], seqs[loop3][sidelen[loop3]+1], seqs[loop3+1][0], loop2 - 1 );
                }
              // #2c: interior
              else
                {
                  //		  char mismatches[4] = { seqs[loop3][loop+1], seqs[loop3+1][loop2-1], seqs[loop3][sidelen[loop3]], seqs[loop3+1][1]};
                  energies[0] = energyModel_Primary->InteriorEnergy( &seqs[loop3][loop], seqs[loop3+1], sidelen[loop3]-loop, loop2-1 );
              ...
              energies[1] = energyModel_Primary->OpenloopEnergy( numAdjacent , sidelengths, sequences );
          ...
          for( loop2 = 1; loop2 <= sidelen[loop4]; loop2++ )
            {
              if( pt = pairtypes[seqs[loop3][loop]][seqs[loop4][loop2]] != 0 )
                {// result is a multiloop and open loop. 
                  ...
                  energies[1] = energyModel_Primary->OpenloopEnergy( numAdjacent - (loop4 - loop3 - 1), sidelengths, sequences );
                  temprate = energyModel_Primary->returnRate( getEnergy(), (energies[0] + energies[1]), 0);
                  loops[0] = loop;
                  loops[1] = loop2;
                  loops[2] = loop3;
